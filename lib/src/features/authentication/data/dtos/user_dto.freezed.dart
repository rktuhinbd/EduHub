...
mixin _$UserDto {
  ...
  @override
  String toString() {
    return 'UserDto(id: $id, email: $email, name: $name, accessToken: $accessToken)';
  }
}
...
extension UserDtoPatterns on UserDto {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String email, String name,
            @JsonKey(name: 'token') String? accessToken)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _UserDto() when $default != null:
        return $default(_that.id, _that.email, _that.name, _that.accessToken);
      case _:
        return orElse();
    }
  }
