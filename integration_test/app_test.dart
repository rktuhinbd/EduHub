...
void main() {
  ...
  group('EduHub App Integration Test', () {
    testWidgets('Full User Flow: Onboarding -> Register -> Home', (tester) async {
      app.main();
      ...
      await tester.enterText(find.ancestor(of: find.text('Phone Number'), matching: find.byType(TextField)), '1234567890');
